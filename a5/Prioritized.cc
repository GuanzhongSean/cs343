...
_Task Prioritized {
   public:
	...
	Prioritized(Priority priority, Intent & me, Intent & you)
		: priority(priority), me(me), you(you) {}
...
int main() {
	...
	Prioritized::Intent me = Prioritized::DontWantIn,
						you = Prioritized::DontWantIn;	// shared
